            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img height="100px" src="{{url('')}}/{{$booking->photo}}" class="rounded" alt=""></td>
                        <td>{{$booking->nama}}</td>
                        ...
                        <td>{{$booking->type}}</td>
                        <td><a class="btn btn-outline-primary" href="{{ route('view.booking',['bookings'=> $booking->id]) }}" role="button">view</a></td>
                        <!-- <td style="width: 50px;"><button class="btn btn-primary"onClick="">View</button></td> -->
                    </tr>
                    @empty
