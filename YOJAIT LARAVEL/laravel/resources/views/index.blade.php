  ...
  <nav class="navbar navbar-expand-lg navbar-light py-1">
    <div class="container-fluid">
      ...
      <div class="col-md-3 text-center mb-4">
        <a class="btn btn-primary mr-2" href="login.html" role="button" style="background:rgb(56, 56, 52)">Log in</a>
        <a class="btn btn-outline-primary" href="sigin.html" role="button">Sign in</a>
      </div>
  </nav>
